...
//     if (req.query.genres) {
//       const genresArray = req.query.genres.split(",").map(genre => genre.trim());
//       const genresRegex = genresArray.map(genre => new RegExp(genre, "i"));
//       filters.genres = { $all: genresRegex };
//     }
...
// // // GET a book by ID
// router.get("/book_id/:id", async (req, res) => {
//   try {
//     const bookId = req.params.id;
...
// // GET top Num book with highest rating
...
//     console.log(`Old genres: ${oldGenres}, New genres: ${newGenres}`);
//     //Update the required book with book_id
//     const updatedBook = await Book.findByIdAndUpdate(bookId, req.body, {
//       new: true,
//     });
